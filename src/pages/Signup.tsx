        ...
        <Card variant="glass" className="p-8 md:p-10 border-emerald-100/50 shadow-2xl relative overflow-hidden">
          ...
          <div className="relative z-10 flex flex-col items-center space-y-6">
            ...
            <div className="flex flex-col items-center space-y-2">
              ...
              <h2 className="text-2xl font-extrabold text-emerald-950 mt-2">Get Started</h2>
              <p className="text-xs text-emerald-700 font-medium">Join Flora AI and grow smarter plants</p>
            </div>
              ...
              <div className="flex items-start">
                <div className="flex items-center h-5">
                  <input
                    ...
                    type="checkbox"
                    required
                    className="h-4 w-4 text-[#22C55E] focus:ring-emerald-500 border-emerald-300 rounded"
                  />
                </div>
                <div className="ml-3 text-xs">
                  <label htmlFor="terms" className="font-medium text-emerald-800">
                    I agree to the{' '}
                    <span className="text-[#16A34A] hover:underline cursor-pointer">Terms of Service</span> and{' '}
                    <span className="text-[#16A34A] hover:underline cursor-pointer">Privacy Policy</span>.
                  </label>
                </div>
              </div>
            ...
            <p className="text-xs font-semibold text-emerald-800">
              ...
              <Link to="/login" className="text-[#16A34A] hover:text-[#22C55E] transition-colors">
                Log In
              </Link>
            </p>
          </div>
